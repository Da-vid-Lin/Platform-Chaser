...
zawarudo_sound = pygame.mixer.Sound('Sound/zawarudo.mp3')
player_images = [
    pygame.transform.scale(pygame.image.load("Images/Slime/walk1.png"), (30, 30)),
    pygame.transform.scale(pygame.image.load("Images/Slime/walk2.png"), (30, 30)),
    pygame.transform.scale(pygame.image.load("Images/Slime/walk3.png"), (30, 30)),
    pygame.transform.scale(pygame.image.load("Images/Slime/walk4.png"), (30, 30)),
    pygame.transform.scale(pygame.image.load("Images/Slime/walk5.png"), (30, 30)),
    pygame.transform.scale(pygame.image.load("Images/Slime/walk6.png"), (30, 30)),
    pygame.transform.scale(pygame.image.load("Images/Slime/walk7.png"), (30, 30)),
    pygame.transform.scale(pygame.image.load("Images/Slime/walk8.png"), (30, 30)),
]
...
class MainGame:
    def __init__(self):
        ...
        #images
        self.bg_image = pygame.image.load("Images/bg.jpg").convert()
        self.bg_image = pygame.transform.scale(self.bg_image, (SCREEN_WIDTH, SCREEN_HEIGHT))
        self.enemy_image = pygame.image.load("Images/enemy.jpg").convert()
    ...
    def game(self):
        ...
        if self.points.collected % self.spawn_rate == 0 and len(self.enemies) < self.points.collected // self.spawn_rate:
            ...
            new_enemy = Enemy(self.screen, "Images/enemy.jpg",pygame.Rect(enemy_x, enemy_y, 30, 30))
        ...
        if random.randint(1,2500) == 1 and self.ability_active == "" and self.abilities == []:
            new_ability = Ability(self.screen, "Images/ability.png",pygame.Rect(random.randint(10, SCREEN_WIDTH - 25), 
